...
function BodyHTML(Ep, similarity, TimeStart, Poster, Banner, Info) {
    let Body = `
      ...
      <div id="Details" class="h-[11vw] w-[86vw] flex" style="margin-left: 16rem">
        <div id="Name">
          <ul class="text-OffWhite ">
            <li>
              <h1 id="border-line" class="text-[3rem] font-name font-bold h-[6.4vh] relative ">JUJUTSU
                KAISEN</h1>
            </li>
        ...
        <div id="result" class="w-[34vw] h-[19vh] mt-[72px] ml-[13px] bg-black flex gap-[17px]">
          <div id="UserIMG"
            class="w-[16vw] h-[19vh] relative flex justify-center items-start flex-col text-[17px] text-center">
            <img
              src="https://www.comingsoon.net/wp-content/uploads/sites/3/2023/09/Jujutsu-Kaisen-Chapter-237-Release-Date.jpg"
              alt="" class="w-full h-[16vh] pt-[8px] object-cover ">
